...
The Community Energy Toolkit helps communities and organizations calculate and predict renewable energy potential from waterfall turbines, geothermal systems, and waste energy recovery. Built for the Earthshot Prize Challenge to democratize renewable energy planning for underserved communities worldwide.
...
1. **PDF Analyzer** (optional): Upload technical documents to auto-extract parameters
2. **Geographic Calculator**: Enter location data, calculate energy potential, export results
3. **Time-Series Predictor**: Generate seasonal forecasts based on climate scenarios

### Batch Analysis CSV Format

```csv
location_name,latitude,longitude,waterfall_height_m,waterfall_flow_m3s,geo_temp_c,depth_km
Chittagong Hills,22.3669,91.7832,45,8.5,180,2.8
...
**Input:**
- Chittagong Hills
- 45m waterfall at 8.5 m³/s
- 180°C geothermal at 2.8km depth
...
- Bangladesh Weather Data: Kaggle (1901-2023)
- Earthshot Prize Challenge
- Streamlit framework
- TensorFlow/Keras
